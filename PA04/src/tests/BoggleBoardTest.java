...
public class BoggleBoardTest
{
    ...
    public void testDoesNotHaveWordOnion()
    {
        ...
        assertFalse( "Word \"onion\" should not be found on board: " + board.toString(), isPresent );       
    }
    ...
    public void testDoesNotHaveWordBoby()
    {
        ...
        assertFalse( "Word \"boby\" should not be found on board: " + board.toString(), isPresent );       
    }
