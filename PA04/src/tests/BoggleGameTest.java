...
public class BoggleGameTest
{
    ...
    {
        assertNotNull( "BoggleBoard object should not be null", BoggleBoard.getBoggleBoard() );
    }

    @Test
    public void testGetDictionary()
    {
        assertNotNull( "Dictionary object should not be null", Dictionary.getBoggleDictionary() );
    }
    
    @Test
    public void testGetPlayer()
    {
        assertNotNull( "BogglePlayer object should not be null", game.getPlayer( BoggleGame.COMPUTER ) );
    }
