 ...
 * @version PA03 (27 October 2016), PA02 (9 October 2016), PA01 (20 September 2016)
 */
abstract public class BogglePlayer implements BoggleConstants
{
     ...
     * 
     * Modification: PA02 - Added the dictionary to the parameter        
     *               PA03 - Removed dictionary from parameter - use Singleton
     *                    - Added new sets for instantiation    
     */
    public BogglePlayer()
    {
        roundScore = 0;
        ...
        dictionary = Dictionary.getBoggleDictionary(); // new for PA2
     ...
     * 
     * Modification: PA02 - new for PA02
     *               PA03 - added default case & removed if statement for 
     *                      length > 7
     *                    - switched set to uniqueSet
     */
     ...
     * 
     * Modification: PA2 - changed WordList to WordSet and changed name
     *                     of method to getSet
     * 
     ...
     *               PA03 - Added removal from other sets
     * 
    ...
    {   
        ...
        // remove from other lists if there
        validSet.remove( word );
        invalidSet.remove( word );
     ...
     * 
     * Modification: PA02 - new for PA2
     *               PA03 - added additional WordSets to clear
     */
    public void reset()
    {
        set.clear();
    ...
    /**
     * Validate the words in the iterator & remove any invalid words from the dictionary
     * 
     * Modification: PA03 - new for PA3
     * 
    ...
    protected void validateWords( Iterator< String > list )
    {
        ...
        while( list.hasNext() )
        {
            ...
            if ( board.hasWord( word ) )
                ...
                if ( this instanceof HumanPlayer ) // no need for invalidSet
                    invalidSet.add( word );        // for the computer player   
