 ...
 *                       in Utilities class.
 *           PA03 Prep - Used Singleton versions of Dictionary and BoggleBoard
 *                PA03 - Added human & computer players, startGame() method
 *                     - Modified getPlayer() method to specify which player
 *                       to return
 * 
 * @author Michael Norton
 * @version PA03 (27 October 2016), PA02 (8 October 2016), PA01 (20 September 2016)
 */
public class BoggleGame implements BoggleConstants
{
    ...
    private Dictionary dictionary; // new for PA2
