 ...
 *                PA03 - Added hasWord() methods to check if word sent is on
 *                       the board or not.
 * 
 * @author Michael Norton
 * @version PA03 (27 October 2016), PA01 (21 September 2016)
 */
public class BoggleBoard
{
     ...
     * @param column the column to start searching
     * @param the shadow array for the board
     * 
    ...
    /**
     * getBoggleBoard -  Singleton method to ensure that there is never more
     *                   than a single BoggleBoard object
     * 
